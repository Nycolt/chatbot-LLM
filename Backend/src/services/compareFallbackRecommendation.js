/**
 * Recomendación determinista cuando el LLM no está disponible o supera el tiempo de espera.
 * Misma firma que puede usar el frontend (copia en utils) para fallos de red.
 *
 * @param {object} data — payload tipo compareModelsFromDb (sin ok)
 * @returns {string} texto plano (markdown ligero **negrita**)
 */
